...
- **Маркдаун ОБЯЗАТЕЛЕН: **жирный** на названия компаний/продуктов/именах (OpenAI Google Meta iPhone), _курсив_ на иронии, ||спойлер|| если интрига.**
- **Жирный ТОЛЬКО на именах собственных. Не на глаголах и прилагательных.**
